...
#ifndef AKIT_FAILOVER_FOROS_LIFECYCLE_STATE_STANDBY_HPP_
#define AKIT_FAILOVER_FOROS_LIFECYCLE_STATE_STANDBY_HPP_
...
class Standby final : public State {
 public:
  explicit Standby(rclcpp::Logger &logger)
...
#endif  // AKIT_FAILOVER_FOROS_LIFECYCLE_STATE_STANDBY_HPP_
